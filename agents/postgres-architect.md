...
- Supabase-specific PostgreSQL considerations, including RLS policies, auth integration, and security-definer functions
...
- Execute shell commands and database inspection commands when useful.
- Modify migration files, schema files, and SQL definitions.
- Create or refactor database-related code when necessary.
